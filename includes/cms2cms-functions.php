...
class CmsPluginFunctionsSMF
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"     : "//wordpress.org/support/plugin/cms2cms-smf-to-bbpress-convertor/reviews",
        "public_host"     : "//www.cms2cms.com",
        "bridge"          : "https://app.cms2cms.com/bridge/download",
        "smfExtension" : "https://cms2cms.com/files/joomla/cms2cmsconnector/com_cms2cmsconnector.zip",
    ...
    {
        $cms2cms_smf_access_login = get_option('cms2cms-smf-login');
        $cms2cms_smf_access_key   = get_option('cms2cms-smf-key');

        return array(
            'email'     => $cms2cms_smf_access_login,
            'accessKey' => $cms2cms_smf_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_smf_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-smf-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-smf-key', $key);

            delete_option('cms2cms-smf-login');
            add_option('cms2cms-smf-login', $login);

            delete_option('cms2cms-smf-depth');
            add_option('cms2cms-smf-depth', $bridge_depth);
    ...
    {
        return $this->__('SMF', 'cms2cms-smf-migration');
    }
    ...
    {
        return $this->__('bbPress', 'cms2cms-smf-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-smf-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-smf-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_smf_logout')
                && $_POST['cms2cms_smf_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
